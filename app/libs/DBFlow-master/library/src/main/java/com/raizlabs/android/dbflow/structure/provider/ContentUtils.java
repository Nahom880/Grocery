...
public class ContentUtils {
    ...
    /**
     * Inserts the list of model into the {@link android.content.ContentResolver}. Binds all of the models to {@link android.content.ContentValues}
     * and runs the {@link android.content.ContentResolver#bulkInsert(android.net.Uri, android.content.ContentValues[])} method. Note: if any of these use
     * autoincrementing primary keys the ROWID will not be properly updated from this method. If you care
     * use {@link #insert(android.content.ContentResolver, android.net.Uri, Model)} instead.
     *
     * @param contentResolver The content resolver to use (if different from {@link com.raizlabs.android.dbflow.config.FlowManager#getContext()})
     ...
     * and runs the {@link android.content.ContentResolver#bulkInsert(android.net.Uri, android.content.ContentValues[])} method. Note: if any of these use
     * autoincrementing primary keys the ROWID will not be properly updated from this method. If you care
     * use {@link #insert(android.net.Uri, Model)} instead.
     *
     * @param bulkInsertUri The URI to bulk insert with
     * @param table         The table to insert into
     * @param models        The models to insert.
