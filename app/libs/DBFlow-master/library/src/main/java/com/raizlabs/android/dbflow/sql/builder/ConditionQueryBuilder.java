...
public class ConditionQueryBuilder<ModelClass extends Model> extends QueryBuilder<ConditionQueryBuilder<ModelClass>> {
    ...
    /**
     * Appends an array of these objects by joining them with a comma by {@link #joinArguments(com.raizlabs.android.dbflow.sql.builder.ConditionQueryBuilder, CharSequence, Object[])}
    ...
    /**
     * Appends a list of these objects by joining them with a comma by {@link #joinArguments(com.raizlabs.android.dbflow.sql.builder.ConditionQueryBuilder, CharSequence, Iterable)}
     * and converting each value into their proper DB value.
     *
    ...
    /**
     * @return the ModelAdapter that this {@link com.raizlabs.android.dbflow.sql.builder.ConditionQueryBuilder} uses.
     */
